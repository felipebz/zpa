...
public class AlterTableTest extends RuleTest {
    ...
    @Test
    public void matchesAlterTableWithOutOfLineConstraint() {
    	assertThat(p).matches("alter table tab add constraint c_name foreign key (f_key) references tab.col (name);");
    }
    
    @Test
    public void matchesAlterTableWithOutOfLineConstraintUsingAndTablespace() {
