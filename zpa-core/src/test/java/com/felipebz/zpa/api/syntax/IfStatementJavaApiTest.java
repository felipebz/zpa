...
class IfStatementJavaApiTest {

    @Test
    void exposesIfStatementViewToJavaSubscribers() {
    ...
    private static class JavaVisitor extends com.felipebz.zpa.api.checks.PlSqlVisitor {
        ...
        @Override
        public void init() {
            subscribeTo(SyntaxViews.IF_STATEMENT, this::visitIfStatement);
        }
        ...
        private void visitIfStatement(IfStatement statement) {
            ...
            for (IfElsifBranch branch : statement.getElsifBranches()) {
                ...
                branch.getStatementsAstNode();
                branch.getStatementAstNodes();
            }
