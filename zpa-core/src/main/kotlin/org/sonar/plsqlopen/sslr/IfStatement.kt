...
class IfStatement(override val astNode: SemanticAstNode) : Tree {
    ...
    val elseClause : SemanticAstNode? by lazy {
        astNode.getFirstChild(PlSqlGrammar.ELSE_CLAUSE) as SemanticAstNode?
    }
