...
enum class SingleRowSqlFunctionsGrammar : GrammarRuleKey {
    ...
    companion object {
        internal val ALTERNATIVES: List<FunctionAlternative> = listOf(
            ...
            FunctionAlternative(JSON_DATAGUIDE_EXPRESSION, JSON_DATAGUIDE),
            FunctionAlternative(JSON_MERGEPATCH_EXPRESSION, JSON_MERGEPATCH),
            FunctionAlternative(JSON_OBJECT_EXPRESSION, JSON_OBJECT, JSON, LBRACE),
            FunctionAlternative(JSON_SCALAR_EXPRESSION, JSON_SCALAR),
            FunctionAlternative(JSON_SERIALIZE_EXPRESSION, JSON_SERIALIZE),
            FunctionAlternative(JSON_QUERY_EXPRESSION, JSON_QUERY),
            FunctionAlternative(JSON_TABLE_EXPRESSION, JSON_TABLE),
            FunctionAlternative(JSON_TRANSFORM_EXPRESSION, JSON_TRANSFORM),
            FunctionAlternative(JSON_VALUE_EXPRESSION, JSON_VALUE),
            FunctionAlternative(XMLATTRIBUTES_EXPRESSION, XMLATTRIBUTES),
            FunctionAlternative(XMLCAST_EXPRESSION, XMLCAST),
            FunctionAlternative(XMLCDATA_EXPRESSION, XMLCDATA),
            FunctionAlternative(XMLCOLATTVAL_EXPRESSION, XMLCOLATTVAL),
            FunctionAlternative(XMLCOMMENT_EXPRESSION, XMLCOMMENT),
            FunctionAlternative(XMLCONCAT_EXPRESSION, XMLCONCAT),
            FunctionAlternative(XMLDIFF_EXPRESSION, XMLDIFF),
            FunctionAlternative(XMLELEMENT_EXPRESSION, XMLELEMENT),
            FunctionAlternative(XMLEXISTS_EXPRESSION, XMLEXISTS),
            FunctionAlternative(XMLFOREST_EXPRESSION, XMLFOREST),
            FunctionAlternative(XMLISVALID_EXPRESSION, XMLISVALID),
            FunctionAlternative(XMLPARSE_EXPRESSION, XMLPARSE),
            FunctionAlternative(XMLPATCH_EXPRESSION, XMLPATCH),
            FunctionAlternative(XMLPI_EXPRESSION, XMLPI),
            FunctionAlternative(XMLQUERY_EXPRESSION, XMLQUERY),
            FunctionAlternative(XMLROOT_EXPRESSION, XMLROOT),
            FunctionAlternative(XMLSEQUENCE_EXPRESSION, XMLSEQUENCE),
            FunctionAlternative(XMLSERIALIZE_EXPRESSION, XMLSERIALIZE),
            FunctionAlternative(XMLTABLE_EXPRESSION, XMLTABLE),
            FunctionAlternative(XMLTRANSFORM_EXPRESSION, XMLTRANSFORM),
            ...
            FunctionAlternative(TO_DATE_EXPRESSION, TO_DATE),
            FunctionAlternative(TO_DSINTERVAL_EXPRESSION, TO_DSINTERVAL),
            FunctionAlternative(TO_NUMBER_EXPRESSION, TO_NUMBER),
            FunctionAlternative(TO_TIMESTAMP_EXPRESSION, TO_TIMESTAMP),
            FunctionAlternative(TO_TIMESTAMP_TZ_EXPRESSION, TO_TIMESTAMP_TZ),
            FunctionAlternative(TO_YMINTERVAL_EXPRESSION, TO_YMINTERVAL),
            FunctionAlternative(TRIM_EXPRESSION, TRIM),
